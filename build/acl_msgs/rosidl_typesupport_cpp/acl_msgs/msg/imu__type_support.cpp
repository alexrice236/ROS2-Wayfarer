...
static const _IMU_type_support_symbol_names_t _IMU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, acl_msgs, msg, IMU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, acl_msgs, msg, IMU)),
  }
};
...
get_message_type_support_handle<acl_msgs::msg::IMU>()
{
  return &::acl_msgs::msg::rosidl_typesupport_cpp::IMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, acl_msgs, msg, IMU)() {
  return get_message_type_support_handle<acl_msgs::msg::IMU>();
}
